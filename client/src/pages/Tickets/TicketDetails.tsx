...
export default function TicketDetails() {
  ...
  useEffect(() => {
    const res = axios.get(`/api/v2/tickets/${ticketId}`);
  }, [ticketId]);
  return (
                ...
                <div className="py-3 xl:pt-6 xl:pb-0">
                  ...
                  <div className="prose max-w-none">
                    ...
                    <ul>
                      ...
                      <li>
                        Semper interdum porta sit tincidunt. Dui suspendisse scelerisque amet metus
                        eget sed. Ut tellus in sed dignissim.
                      </li>
                    </ul>
                  </div>
                </div>
