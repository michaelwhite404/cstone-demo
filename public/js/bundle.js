...
exports.checkInDevice = exports.checkOutDevice = exports.addDevice = exports.editDevice = void 0;
...
if (checkInForm) {
  ...
  $(checkInForm).on("submit", function (e) {
    ...
    if ($("#checkin-checkbox").is(":checked")) {
      var deviceId = $(checkInForm).attr("data-device");
      (0, _device.checkInDevice)();
    }
  });
}
