...
exports.editUser = exports.newUser = void 0;
...
var newUser = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, title, email, role, grade) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "New user added!");
              window.setTimeout(function () {
  ...
  return function newUser(_x, _x2, _x3, _x4, _x5, _x6) {
    return _ref.apply(this, arguments);
  };
}();
...
var editUser = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(firstName, lastName, title, email, role, grade, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "User edited!");
              window.setTimeout(function () {
                location.assign("/users/".concat(res.data.data.employee.slug, "/edit"));
              }, 1500);
            }
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"student.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.editStudent = exports.newStudent = void 0;
...
var newStudent = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(firstName, lastName, status, grade, schoolEmail, personalEmail, customID) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Student added successfully!");
              window.setTimeout(function () {
  ...
  return function newStudent(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();
...
var editStudent = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(firstName, lastName, status, grade, schoolEmail, personalEmail, customID, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
  ...
  return function editStudent(_x8, _x9, _x10, _x11, _x12, _x13, _x14, _x15) {
    return _ref2.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"../../node_modules/capitalize/index.js":[function(require,module,exports) {
...
exports.createError = exports.updateError = exports.checkInDevice = exports.checkOutDevice = exports.addDevice = exports.editDevice = void 0;
...
var editDevice = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, brand, model, serialNumber, macAddress, status) {
    var _window$pageData, id, deviceType, res;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _window$pageData = window.pageData, id = _window$pageData.id, deviceType = _window$pageData.deviceType;
            _context.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: "/api/v1/".concat((0, _pluralize.default)(deviceType), "/").concat(id),
              data: {
                name: name,
                brand: brand,
                model: model,
...
var addDevice = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, brand, model, serialNumber, macAddress, status) {
    var deviceTypePlural, res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            deviceTypePlural = window.location.pathname.split("/")[1];
            _context2.next = 4;
            return (0, _axios.default)({
              method: "POST",
              url: "/api/v1/".concat(deviceTypePlural),
              data: {
                name: name,
                brand: brand,
                model: model,
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            _context3.prev = 0;
            _window$pageData2 = window.pageData, id = _window$pageData2.id, deviceType = _window$pageData2.deviceType;
            _context3.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
...
var checkInDevice = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(error, checkInDate, title, description) {
    var _window$pageData3, id, deviceType, res;
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            _context4.prev = 0;
            _window$pageData3 = window.pageData, id = _window$pageData3.id, deviceType = _window$pageData3.deviceType;
            _context4.next = 4;
            return (0, _axios.default)({
              method: "PATCH",
              url: "/api/v1/".concat((0, _pluralize.default)(deviceType), "/").concat(id, "/check-in"),
              data: {
                error: error,
  ...
  return function checkInDevice(_x16, _x17, _x18, _x19) {
    return _ref4.apply(this, arguments);
  };
}();

exports.checkInDevice = checkInDevice;

var updateError = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(errorId, status, description) {
    var res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "/api/v1/error-logs/".concat(errorId),
              data: {
                status: status,
                description: description
              }
  ...
  return function updateError(_x20, _x21, _x22) {
...
var createError = /*#__PURE__*/function () {
  ...
  return function createError(_x23, _x24, _x25) {
    return _ref6.apply(this, arguments);
  };
}();

exports.createError = createError;
},{"axios":"../../node_modules/axios/index.js","capitalize":"../../node_modules/capitalize/index.js","pluralize":"../../node_modules/pluralize/pluralize.js","./alerts":"alerts.js"}],"../../node_modules/moment/moment.js":[function(require,module,exports) {
var define;
var global = arguments[3];
//! moment.js
//! version : 2.29.1
...
var editDeviceForm = $("#edit-device");
var addDeviceForm = $("#add-device");
var newUserForm = $("#new-user");
var editUserForm = $("#edit-user");
var newStudentForm = $("#new-student");
var editStudentForm = $("#edit-student");
...
var fakeboxFormat = function fakeboxFormat(el) {
  ...
  $(dateText).text(date);
  if ($(el).data("invalid") === "future") if (new Date(dateStr).getTime() > new Date(Date.now()).getTime()) {
  ...
  if ($(el).data("invalid") === "past") if (new Date(dateStr).getTime() < new Date(Date.now()).getTime()) {
    $(el).prev().css("color", "red");
    return false;
  } else {
    $(el).prev().css("color", "cornflowerblue");
...
if (newUserForm) {
  $(newUserForm).on("submit", function (e) {
    ...
    (0, _user.newUser)(firstName, lastName, title, email, role, grade);
  });
}
...
if (editUserForm) {
  $(editUserForm).on("submit", function (e) {
    e.preventDefault();
    var grade;
    var firstName = $("#edit-user-first-name").val();
    var lastName = $("#edit-user-last-name").val();
    var title = $("#edit-user-title").val();
    ...
    var id = $("#edit-user").attr("data-employee");
    (0, _user.editUser)(firstName, lastName, title, email, role, grade, id);
  });
}
...
if (newStudentForm) {
  $(newStudentForm).on("submit", function (e) {
    e.preventDefault();
    var grade, personalEmail, customID;
    var firstName = $("#new-student-first-name").val();
    var lastName = $("#new-student-last-name").val();
    var status = $("#new-student-status").val();
    var schoolEmail = $("#new-student-school-email").val();
    ...
    (0, _student.newStudent)(firstName, lastName, status, grade, schoolEmail, personalEmail, customID);
  });
}
...
if (editStudentForm) {
  $(editStudentForm).on("submit", function (e) {
    ...
    var grade = null,
        personalEmail = null,
        customID = null;
    var firstName = $("#edit-student-first-name").val();
    var lastName = $("#edit-student-last-name").val();
    var status = $("#edit-student-status").val();
    var schoolEmail = $("#edit-student-school-email").val();
...
if ($(checkOutForm)) {
  ...
  $(gradeSelect).change(function () {
    if ($(gradeSelect).val() == -1) {
      ...
      $("select.student-list").css("display", "none"); // Show Correct Grade List
...
if (checkInForm) {
  ...
  var checkOutDate = $("#checkin-date").data("checkout-date");
  /**
  ...
  var testFields = function testFields(submit) {
    ...
    if ($("input[name='Check In Status']:checked").val() === "Error") $("#error-text-fields-checkin .form-text-field").each(function () {
      if ($(this).val().length < 1) {
        disable = true;
        return;
      }
    });else if ($("input[name='Check In Status']:checked").val() !== "Fine") disable = true;

    if ($("#checkin-date-checker").is(":checked")) {
      if ($("#checkin-date").val()) {
        var dateEl = $("#checkin-date");
        var datePicked = new Date(dateEl.val()).toISOString();
        if (!(0, _moment.default)(datePicked).isBetween(dateEl.data("checkout-date"), undefined)) disable = true;
      } else disable = true;
    }
  ...
  $("input[name='Check In Status']").on("change", function () {
    var $errorFields = $("#error-text-fields-checkin"); // If error, show errror box

    if ($("input[name='Check In Status']:checked").val() == "Error") $errorFields.slideDown(750);else $errorFields.slideUp(750);
    testFields();
  });
  ...
  var afterCheckout = function afterCheckout(el) {
    var setDate = new Date($(el).val()).toISOString();

    if ((0, _moment.default)(setDate).diff(checkOutDate) <= 0) {
      $(el).prev().css("color", "red");
      return false;
    } else {
      $(el).prev().css("color", "cornflowerblue");
  ...
  $("#checkin-form .date-wrapper input[type='checkbox']").on("change", function () {
    toggleDateHolder($(this));
    testFields();
  });
  ...
  $(checkInForm).on("submit", /*#__PURE__*/function () {
    var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(e) {
      var status, success, checkInDate, title, description;
      return regeneratorRuntime.wrap(function _callee5$(_context5) {
        while (1) {
          switch (_context5.prev = _context5.next) {
            case 0:
              ...
              if ($("#checkin-date-checker").is(":checked")) checkInDate = new Date($("#checkin-date").val()).toISOString();
              ...
              _context5.next = 11;
              return (0, _device.checkInDevice)(true, checkInDate, title, description);
            ...
            case 14:
              _context5.next = 16;
              return (0, _device.checkInDevice)(false, checkInDate);
...
if (updateErrorForm) {
  var _testFields = function _testFields(submit) {
    ...
    $("input[name='Update Status']").each(function () {
      if ($(this).is(":checked")) {
        ...
        if ($(this).val() === "Fixed" || $(this).val() === "Unfixable") {
          var message = '*Updating this error to "' + $(this).val() + '" will finalize the error';
          $(".pop-text").empty();
  ...
  function waveTrigger(event) {
    // Get clicked element
    var $element = event.target; // Create ripple element and append to $element

    var $waves = document.createElement("div");
    $waves.classList.add("waves-ripple"); // Position waves where we clicked

    $waves.style.left = event.offsetX + "px";
    $waves.style.top = event.offsetY + "px";
    $element.appendChild($waves); // Wait a tick!

    $waves.offsetWidth; // Then begin ripple effect.

    var elementWidth = $element.offsetWidth;
    var elementHeight = $element.offsetHeight;
    var scale = Math.max(elementHeight, elementWidth) / Math.min(elementHeight, elementWidth) * 1.53;
  ...
  function waveCheckRelease($element) {
    var isStillWaving; // Loop through all ripples
  ...
  function onMouseDown(event) {
    var $target = event.target; // Check if this element needs the wave-effect + trigger it if so.
  ...
  function onMouseUp(event) {
    var $target = event.target; // Begin checking for whether or not this effect has ended
...
$(firstPasswordForm).on("submit", function (e) {
  ...
  var passwordConfirm = $("#first-password-confirm").val();
  (0, _password.updatePassword)(password, passwordConfirm);
});
$(".go-to-error").on("click", function () {
  var errorId = $(this).data("error-id");
  var errorRow = $("#" + errorId);
