...
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"chromebook.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.checkIn = exports.checkOut = exports.addChromebook = exports.editChromebook = void 0;
...
var editChromebook = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, brand, model, serialNumber, macAddress, status, id) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:8080/api/v1/chromebooks/".concat(id),
              data: {
                name: name,
                brand: brand,
                model: model,
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Chromebook edit successful!");
              window.setTimeout(function () {
                location.assign("/chromebooks/".concat(res.data.data.chromebook.slug));
              }, 1500);
            }
  ...
  return function editChromebook(_x, _x2, _x3, _x4, _x5, _x6, _x7) {
    return _ref.apply(this, arguments);
  };
}();

exports.editChromebook = editChromebook;

var addChromebook = /*#__PURE__*/function () {
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Chromebook Added!");
              window.setTimeout(function () {
                location.assign("/chromebooks/".concat(res.data.data.chromebook.slug));
              }, 1500);
            }
  ...
  return function addChromebook(_x8, _x9, _x10, _x11, _x12, _x13) {
    return _ref2.apply(this, arguments);
  };
}();

exports.addChromebook = addChromebook;

var checkOut = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(lastUser, chromebookId) {
    var res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:8080/api/v1/chromebooks/".concat(chromebookId, "/check-out"),
              data: {
                lastUser: lastUser
              }
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Chromebook checkout successful!");
              window.setTimeout(function () {
  ...
  return function checkOut(_x14, _x15) {
...
var checkIn = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(chromebookId) {
    var res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:8080/api/v1/chromebooks/".concat(chromebookId, "/check-in"),
              data: {}
            });
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              (0, _alerts.showAlert)("success", "Chromebook checked in!");
              window.setTimeout(function () {
                location.reload(true);
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:8080/api/v1/users/".concat(id),
              data: {
                firstName: firstName,
                lastName: lastName,
                title: title,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === "success") {
              ...
              window.setTimeout(function () {
                location.assign("/students/".concat(res.data.data.student.slug));
              }, 1500);
            }
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            ...
            return (0, _axios.default)({
              method: "PATCH",
              url: "http://127.0.0.1:8080/api/v1/students/".concat(id),
              data: {
                firstName: firstName,
                lastName: lastName,
                status: status,
...
var _chromebook = require("./chromebook");
...
var editChromebookForm = $("#edit-chromebook");
var addChromebookForm = $("#add-chromebook");
...
if (editChromebookForm) {
  $(editChromebookForm).on("submit", function (e) {
    e.preventDefault();
    var name = $("#edit-chromebook-name").val();
    var brand = $("#edit-chromebook-brand").val();
    var model = $("#edit-chromebook-model").val();
    var serialNumber = $("#edit-chromebook-sn").val();
    var macAddress = $("#edit-chromebook-mac").val();
    var status = $("#edit-chromebook-status").find(":selected").val();
    var id = $("#edit-chromebook").attr("data-chromebook");
    (0, _chromebook.editChromebook)(name, brand, model, serialNumber, macAddress, status, id);
  });
}

if (addChromebookForm) {
  $(addChromebookForm).on("submit", function (e) {
    e.preventDefault();
    var name = $("#create-chromebook-name").val();
    var brand = $("#create-chromebook-brand").val();
    var model = $("#create-chromebook-model").val();
    var serialNumber = $("#create-chromebook-sn").val();
    var macAddress = $("#create-chromebook-mac").val();
    var status = $("#create-chromebook-status").find(":selected").val();
    (0, _chromebook.addChromebook)(name, brand, model, serialNumber, macAddress, status);
  });
}
...
if ($(checkOutForm)) {
  ...
  $(checkOutForm).on("submit", function (e) {
    ...
    var chromebookId = $(checkOutForm).attr("data-chromebook");

    if (changeValue != -1 && studentId != -1) {
      (0, _chromebook.checkOut)(studentId, chromebookId);
    }
  });
} // Check In
...
if (checkInForm) {
  ...
  $(checkInForm).on("submit", function (e) {
    ...
    if ($("#checkin-checkbox").is(":checked")) {
      var chromebookId = $(checkInForm).attr("data-chromebook");
      (0, _chromebook.checkIn)(chromebookId);
    }
  });
}
