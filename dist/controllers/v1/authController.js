...
exports.updatePassword = exports.resetPassword = exports.forgotPassword = exports.restrictTo = exports.isLoggedIn = exports.protect = exports.logout = exports.login = exports.createEmployee = exports.signup = exports.createSendGoogleToken = exports.createSendToken = void 0;
...
exports.createSendGoogleToken = catchAsync_1.default((req, res) => {
...
exports.signup = catchAsync_1.default(async (req, res, next) => {
    ...
    req.body.password = makePassword_1.default(12);
    const newEmployee = await employeeModel_1.default.create(req.body);
    exports.createSendToken(newEmployee, 201, res);
});
exports.createEmployee = catchAsync_1.default(async (req, res, next) => {
    ...
    await new email_1.default(req.body, url).sendWelcome();
    // Remove password from output
...
exports.login = catchAsync_1.default(async (req, res, next) => {
    ...
    exports.createSendToken(employee, 200, res);
});
const logout = (_, res) => {
...
const isLoggedIn = async (req, res, next) => {
    if (req.cookies.jwt) {
        try {
            ...
            // @ts-ignore
            const decoded = await util_1.promisify(jsonwebtoken_1.default.verify)(req.cookies.jwt, 
            // @ts-ignore
...
exports.forgotPassword = catchAsync_1.default(async (req, res, next) => {
    ...
    try {
        ...
        //   message,
        // });
        await new email_1.default(employee, resetURL).sendPasswordReset();
        res.status(200).json({
            status: "success",
...
exports.updatePassword = catchAsync_1.default(async (req, res, next) => {
    ...
    const employee = await employeeModel_1.default.findById(req.employee._id).select("+password");
    if (!employee) {
        return next(new appError_1.default("You are not logged in", 403));
    }
